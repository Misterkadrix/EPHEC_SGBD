...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit', href: `/equipment/${props.equipment.id}/edit` },
];

const form = useForm({
    site_id: props.equipment.site_id.toString(),
    type_id: props.equipment.type_id.toString(),
    is_mobile: props.equipment.is_mobile,
    fixed_room_id: props.equipment.fixed_room_id?.toString() || '',
});
        ...
        <div class="max-w-2xl mx-auto p-6">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Mettez à jour les informations de l'équipement</CardDescription>
                </CardHeader>
                <CardContent>
